...
def main(args):
    ...
    if cont_training:
        ...
        best_model_path = model_dir + natsorted(os.listdir(model_dir))[0]
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        for data in train_loader:
            ...
            logger.info('Iter {} of {} loss {:.4f}, Reg: {:.6f}, loss net a: {:.6f}'.format(idx, len(train_loader), loss_out, loss_reg, loss_net))
        ...
        with torch.no_grad():
            for data in val_loader:
                ...
                flow = visuals['flow_A']
                def_out = reg_model(x.cuda().float(), flow.cuda())
        ...
        best_mse = max(eval_dsc_new_y.avg, best_mse)
...
if __name__ == '__main__':
    ...
    # Argument parser
    parser = argparse.ArgumentParser(description='Train CycleMorph Model for Image Registration')
...
# python train_cyclemorph.py --t1_dir ./Registration_Data/T1_Moving/ --dwi_dir ./Registration_Data/Diffusion_Fixed/ --epochs 100 --img_size 128,128,128 --lr 2e-4 --batch_size 2 --cont_training
