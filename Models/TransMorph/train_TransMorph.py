...
def main(args):
    ...
    save_dir = 'transmorph_1_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
    ...
    if cont_training:
        ...
        logger.info('Model: {} loaded!'.format(natsorted(os.listdir(model_dir))[-1]))
    ...
    }, save_dir='experiments/' + save_dir, filename='final_model_transmorph.pth.tar')
...
if __name__ == '__main__':
    ...
    # Argument parser
    parser = argparse.ArgumentParser(description='Train TransMorph Model for Image Registration')
...
# python train_transmorph.py --t1_dir ./Registration_Data/T1_Moving/ --dwi_dir ./Registration_Data/Diffusion_Fixed/ --epochs 100 --img_size 128,128,128 --lr 2e-4 --batch_size 2 --cont_training
