...
def main(args):
    ...
    save_dir = 'vitvnet_1_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
    ...
    }, save_dir='experiments/' + save_dir, filename='final_model_vitvnet.pth.tar')
...
if __name__ == '__main__':
    ...
    # Argument parser
    parser = argparse.ArgumentParser(description='Train ViT-V-Net Model for Image Registration')
...
# python train_vitvnet.py --t1_dir ./Registration_Data/T1_Moving/ --dwi_dir ./Registration_Data/Diffusion_Fixed/ --epochs 100 --img_size 128,128,128 --lr 2e-4 --batch_size 2 --cont_training
